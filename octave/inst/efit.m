function [ center, radii, evecs, v, chi2 ] = efit( X, equals )
%
% Fit an ellispoid/sphere/paraboloid/hyperboloid to a set of xyz data points:
%
%   [center, radii, evecs, pars ] = efit( X )
%   [center, radii, evecs, pars ] = efit( [x y z] );
%   [center, radii, evecs, pars ] = efit( X, 1 );
%   [center, radii, evecs, pars ] = efit( X, 2, 'xz' );
%   [center, radii, evecs, pars ] = efit( X, 3 );
%
% Parameters:
